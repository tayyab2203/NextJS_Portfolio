      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <motion.h1
            ...
            className="text-9xl font-bold bg-gradient-to-r from-toffee_brown via-camel to-khaki_beige bg-clip-text text-transparent mb-4 font-comfortaa"
          >
            404
          </motion.h1>
          <h2 className="text-3xl md:text-4xl font-bold text-khaki_beige-900 mb-4 font-comfortaa">
            Page Not Found
          </h2>
          <p className="text-dry_sage-700 text-lg mb-8 max-w-md mx-auto">
